...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data ingestion completed and artfact is {data_ingestion_artifact}")
            return data_ingestion_artifact
        except Exception as e:
            logging.error("Error in TrainingPipeline __init__ method")
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            logging.error("Error in TrainingPipeline start_data_validation method")
            raise NetworkSecurityException(e,sys)
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            logging.error("Error in TrainingPipeline start_data_transformation method")
            raise NetworkSecurityException(e,sys)
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            logging.error("Error in TrainingPipeline start_model_trainer method")
            raise NetworkSecurityException(e,sys)
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            ...
            logging.error("Error in TrainingPipeline sync_artifact_dir_to_s3 method")
            raise NetworkSecurityException(e,sys)
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            logging.error("Error in TrainingPipeline sync_saved_model_dir_to_s3 method")
            raise NetworkSecurityException(e,sys)
    ...
    def run_pipeline(self):
        try:
            ...
            logging.error("Error in TrainingPipeline run_pipeline method")
            raise NetworkSecurityException(e,sys)
