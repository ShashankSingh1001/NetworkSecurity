...
class TrainingPipelineConfig:
    def __init__(self,timestamp=datetime.now()):
        ...
        self.artifact_dir = os.path.join(training_pipeline.ARTIFACTS_DIR,timestamp)
...
class DataingestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.train_test_split_ratio:float = training_pipeline.DATA_INEGSTION_TRAIN_TEST_SPLIT_RATIO
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_path:str = os.path.join(self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,training_pipeline.MODEL_FILE_NAME)
