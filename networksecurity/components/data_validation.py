...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,
        ...
        try:
            ...
            logging.error("Error in DataValidation __init__ method")
    ...
    def read_data(file_path:str)->pd.DataFrame:
        try:
            ...
            logging.error(f"Error in read_data method: {file_path}")
            raise NetworkSecurityException(e,sys)
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            if len(dataframe.columns) != number_of_columns:
                logging.error(f"Number of columns mismatch: {len(dataframe.columns)} != {number_of_columns}")
                return False
            return True
        except Exception as e:
            logging.error("Error in validate_number_of_columns method")
            raise NetworkSecurityException(e,sys)
    ...
    def detect_data_drift(self,base_df,current_df,threshold=0.05)->bool:
        try:
            ...
            logging.error("Error in detect_data_drift method")
            raise NetworkSecurityException(e,sys)
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            logging.error("Error in initiate_data_validation method")
            raise NetworkSecurityException(e,sys)